...
@implementation MKMTTextButtonCellModel
@end

@interface MKMTTextButtonCell ()
...
@implementation MKMTTextButtonCell

+ (MKMTTextButtonCell *)initCellWithTableView:(UITableView *)tableView {
    MKMTTextButtonCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMTTextButtonCellIdenty"];
    if (!cell) {
        cell = [[MKMTTextButtonCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMTTextButtonCellIdenty"];
    }
    return cell;
}
...
- (void)rightButtonPressed {
    if ([self.delegate respondsToSelector:@selector(mt_textButtonCell_buttonAction:)]) {
        [self.delegate mt_textButtonCell_buttonAction:self.dataModel.index];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKMTTextButtonCellModel *)dataModel {
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKMTTextButtonCellModel.class]) {
        return;
    }
