...
@implementation MKMTCreateLoRaDeviceModel
...
- (NSDictionary *)params {
    ...
    NSString *model = @"60";
    NSString *applicationIdFull = @"LW008";
    NSString *profilesType = @"008";
...
@interface MKMTNetworkService ()

@property (nonatomic, strong)NSURLSessionDataTask *addLoRaDeviceTask;

@end

@implementation MKMTNetworkService

+ (instancetype)share {
    static dispatch_once_t t;
    static MKMTNetworkService *service = nil;
    dispatch_once(&t, ^{
        service = [[MKMTNetworkService alloc] init];
    });
    return service;
}

- (void)addLoRaDeviceToCloud:(MKMTCreateLoRaDeviceModel *)deviceModel
