...
static MKMTUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKMTUserLoginManager ()
...
+ (MKMTUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKMTUserLoginManager new];
        }
    });
    return loginManager;
}
