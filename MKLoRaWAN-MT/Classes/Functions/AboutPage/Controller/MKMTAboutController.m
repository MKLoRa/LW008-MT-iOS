...
@implementation MKMTAboutController

- (void)dealloc {
    NSLog(@"MKMTAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTAboutController", @"mt_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTAboutController", @"mt_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
