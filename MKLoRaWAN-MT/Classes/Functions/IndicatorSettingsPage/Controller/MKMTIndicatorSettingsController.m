//
//  MKMTIndicatorSettingsController.m
...
@interface MKMTIndicatorSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMTIndicatorSettingsModel *dataModel;

@end

@implementation MKMTIndicatorSettingsController

- (void)dealloc {
    NSLog(@"MKMTIndicatorSettingsController销毁");
}
...
- (void)loadSection0Datas {
    ...
    cellModel1.index = 0;
    cellModel1.msg = @"Low-power";
    cellModel1.isOn = self.dataModel.LowPower;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MT", @"MKMTIndicatorSettingsController", @"mt_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMTIndicatorSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMTIndicatorSettingsModel alloc] init];
    }
    return _dataModel;
}
