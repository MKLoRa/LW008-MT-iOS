...
@interface MKMTBleFixController ()<UITableViewDelegate,
UITableViewDataSource,
MKTextFieldCellDelegate,
MKNormalSliderCellDelegate,
MKMTFilterRelationshipCellDelegate>
...
@implementation MKMTBleFixController

- (void)dealloc {
    NSLog(@"MKMTBleFixController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MT", @"MKMTBleFixController", @"mt_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMTBleFixDataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMTBleFixDataModel alloc] init];
    }
    return _dataModel;
}
