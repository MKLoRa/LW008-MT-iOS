...
@implementation MKMTMsgIconButton
...
@interface MKMTSynTableHeaderView ()
...
@property (nonatomic, strong)MKMTMsgIconButton *synButton;

@property (nonatomic, strong)MKMTMsgIconButton *emptyButton;

@property (nonatomic, strong)MKMTMsgIconButton *exportButton;
...
@implementation MKMTSynTableHeaderView
...
- (MKMTMsgIconButton *)synButton {
    if (!_synButton) {
        _synButton = [[MKMTMsgIconButton alloc] init];
        _synButton.topIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTSynTableHeaderView", @"mt_sync_enableIcon.png");
        _synButton.msgLabel.text = @"Sync";
    }
    return _synButton;
}

- (MKMTMsgIconButton *)emptyButton {
    if (!_emptyButton) {
        _emptyButton = [[MKMTMsgIconButton alloc] init];
        _emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTSynTableHeaderView", @"mt_delete_enableIcon.png");
        _emptyButton.msgLabel.text = @"Empty";
    }
    return _emptyButton;
}

- (MKMTMsgIconButton *)exportButton {
    if (!_exportButton) {
        _exportButton = [[MKMTMsgIconButton alloc] init];
        _exportButton.topIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTSynTableHeaderView", @"mt_export_enableIcon.png");
