...
static NSString *const MKMTSynDataCellIdenty = @"MKMTSynDataCellIdenty";

@interface MKMTSynDataCell ()
...
@implementation MKMTSynDataCell

+ (MKMTSynDataCell *)initCellWithTableView:(UITableView *)tableView {
    MKMTSynDataCell *cell = [tableView dequeueReusableCellWithIdentifier:MKMTSynDataCellIdenty];
    if (!cell) {
        cell = [[MKMTSynDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:MKMTSynDataCellIdenty];
    }
    return cell;
}
