...
@interface MKMTSynDataController ()<UITableViewDelegate,
UITableViewDataSource,
MFMailComposeViewControllerDelegate,
mk_mt_storageDataDelegate>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKMTSynTableHeaderView *headerView;
...
@implementation MKMTSynDataController

- (void)dealloc {
    NSLog(@"MKMTSynDataController销毁");
    if (self.dataTimer) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [MKMTSynDataCell fetchCellHeight:self.dataList[indexPath.row]];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKMTSynDataCell *cell = [MKMTSynDataCell initCellWithTableView:tableView];
...
- (void)processStatus {
    ...
    if (self.dataList.count > 0) {
        ...
        self.headerView.synButton.topIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_sync_disableIcon.png");
        
        self.headerView.emptyButton.enabled = NO;
        self.headerView.emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_delete_disableIcon.png");
...
- (void)startButtonMethod {
    ...
    self.headerView.synButton.topIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_sync_enableIcon.png");
    [self.headerView.synButton.topIcon.layer removeAnimationForKey:synIconAnimationKey];
    //开始旋转
...
- (void)syncButtonStateUpdate {
    ...
    if (self.headerView.synButton.selected) {
        ...
        self.headerView.emptyButton.topIcon.image = (enable ? LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_delete_enableIcon.png") : LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_delete_disableIcon.png"));
        
        self.headerView.exportButton.enabled = enable;
        self.headerView.exportButton.topIcon.image = (enable ? LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_export_enableIcon.png") : LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_export_disableIcon.png"));
...
- (void)emptyButtonMethod {
    ...
    self.headerView.emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-MT", @"MKMTSynDataController", @"mt_delete_enableIcon.png");
...
- (void)saveDataToLocal {
    ...
    [[NSUserDefaults standardUserDefaults] setValue:SafeStr(self.totalSum) forKey:@"mt_recordDataTotalSumKey"];
    if (self.dataList.count == 0) {
        [[MKHudManager share] hide];
...
- (MKMTSynTableHeaderView *)headerView {
    if (!_headerView) {
        _headerView = [[MKMTSynTableHeaderView alloc] initWithFrame:CGRectMake(0, 0, kViewWidth, 100.f)];
