...
@implementation MKMTButtonMsgCellModel
...
@implementation MKMTButtonMsgCell

+ (MKMTButtonMsgCell *)initCellWithTableView:(UITableView *)tableView {
    MKMTButtonMsgCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMTButtonMsgCellIdenty"];
    if (!cell) {
        cell = [[MKMTButtonMsgCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMTButtonMsgCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKMTButtonMsgCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKMTButtonMsgCellModel.class]) {
        return;
    }
