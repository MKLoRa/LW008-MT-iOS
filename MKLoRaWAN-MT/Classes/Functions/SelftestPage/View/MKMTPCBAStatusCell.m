...
@implementation MKMTPCBAStatusCellModel
@end

@interface MKMTPCBAStatusCell ()
...
@implementation MKMTPCBAStatusCell

+ (MKMTPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKMTPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMTPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKMTPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMTPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKMTPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKMTPCBAStatusCellModel.class]) {
        return;
    }
