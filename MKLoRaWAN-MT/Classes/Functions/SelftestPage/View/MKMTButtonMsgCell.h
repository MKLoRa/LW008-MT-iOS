...
@interface MKMTButtonMsgCellModel : NSObject
...
@protocol MKMTButtonMsgCellDelegate <NSObject>
...
@interface MKMTButtonMsgCell : MKBaseCell

@property (nonatomic, strong)MKMTButtonMsgCellModel *dataModel;

@property (nonatomic, weak)id <MKMTButtonMsgCellDelegate>delegate;
