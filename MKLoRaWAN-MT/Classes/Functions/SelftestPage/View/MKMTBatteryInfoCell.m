...
@implementation MKMTBatteryInfoCellModel
@end

@interface MKMTBatteryInfoCell ()
...
@implementation MKMTBatteryInfoCell

+ (MKMTBatteryInfoCell *)initCellWithTableView:(UITableView *)tableView {
    MKMTBatteryInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMTBatteryInfoCellIdenty"];
    if (!cell) {
        cell = [[MKMTBatteryInfoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMTBatteryInfoCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKMTBatteryInfoCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKMTBatteryInfoCellModel.class]) {
        return;
    }
