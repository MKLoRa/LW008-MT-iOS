...
@implementation MKMTSelftestCellModel
@end

@interface MKMTSelftestCell ()
...
@implementation MKMTSelftestCell

+ (MKMTSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKMTSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMTSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKMTSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMTSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKMTSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKMTSelftestCellModel.class]) {
        return;
    }
