...
@interface MKMTLoRaSettingConfigModel : NSObject
...
@interface MKMTLoRaSettingModel : NSObject

@property (nonatomic, strong, readonly)MKMTLoRaSettingConfigModel *configModel;
