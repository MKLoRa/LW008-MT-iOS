...
@implementation MKMTLoRaSettingConfigModel
...
@interface MKMTLoRaSettingModel ()

@property (nonatomic, strong)dispatch_queue_t readQueue;

@property (nonatomic, strong)dispatch_semaphore_t semaphore;

@property (nonatomic, strong)MKMTLoRaSettingConfigModel *configModel;

@end

@implementation MKMTLoRaSettingModel
...
- (BOOL)configModem {
    __block BOOL success = NO;
    [MKMTInterface mt_configModem:(self.modem - 1) sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRegion {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanRegionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRegion {
    __block BOOL success = NO;
    [MKMTInterface mt_configRegion:self.currentRegion sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevEUI {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanDEVEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevEUI {
    __block BOOL success = NO;
    [MKMTInterface mt_configDEVEUI:self.devEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppEUI {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanAPPEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppEUI {
    __block BOOL success = NO;
    [MKMTInterface mt_configAPPEUI:self.appEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppKey {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanAPPKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppKey {
    __block BOOL success = NO;
    [MKMTInterface mt_configAPPKEY:self.appKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevAddr {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanDEVADDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevAddr {
    __block BOOL success = NO;
    [MKMTInterface mt_configDEVADDR:self.devAddr sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppSkey {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanAPPSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppSkey {
    __block BOOL success = NO;
    [MKMTInterface mt_configAPPSKEY:self.appSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMessageType {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanMessageTypeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMessageType {
    __block BOOL success = NO;
    [MKMTInterface mt_configMessageType:self.messageType sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNwkSkey {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanNWKSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNwkSkey {
    __block BOOL success = NO;
    [MKMTInterface mt_configNWKSKEY:self.nwkSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCHValue {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanCHWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCHValue {
    __block BOOL success = NO;
    [MKMTInterface mt_configCHL:self.CHL CHH:self.CHH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDutyStatus {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanDutyCycleStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDutyStatus {
    __block BOOL success = NO;
    [MKMTInterface mt_configDutyCycleStatus:self.dutyIsOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readJoinValue {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configJoinValue {
    __block BOOL success = NO;
    [MKMTInterface mt_configDR:self.join sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUplinkStrategy {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanUplinkStrategyWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUplinkStrategy {
    __block BOOL success = NO;
    [MKMTInterface mt_configUplinkStrategy:self.adrIsOn transmissions:(self.transmissions + 1) DRL:self.DRL DRH:self.DRH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRetransmission {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanMaxRetransmissionTimesWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRetransmission {
    __block BOOL success = NO;
    [MKMTInterface mt_configLorawanMaxRetransmissionTimes:(self.retransmission + 1) sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readACKLimit {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanADRACKLimitWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configACKLimit {
    __block BOOL success = NO;
    [MKMTInterface mt_configLorawanADRACKLimit:[self.ackLimit integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readACKDelay {
    __block BOOL success = NO;
    [MKMTInterface mt_readLorawanADRACKDelayWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configACKDelay {
    __block BOOL success = NO;
    [MKMTInterface mt_configLorawanADRACKDelay:[self.ackDelay integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)restartDevice {
    __block BOOL success = NO;
    [MKMTInterface mt_restartDeviceWithSucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (MKMTLoRaSettingConfigModel *)configModel {
    if (!_configModel) {
        _configModel = [[MKMTLoRaSettingConfigModel alloc] init];
    }
    return _configModel;
}
