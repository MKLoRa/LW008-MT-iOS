...
@interface MKMTPeriodicModeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMTPeriodicModeModel *dataModel;

@end

@implementation MKMTPeriodicModeController

- (void)dealloc {
    NSLog(@"MKMTPeriodicModeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MT", @"MKMTPeriodicModeController", @"mt_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMTPeriodicModeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMTPeriodicModeModel alloc] init];
    }
    return _dataModel;
}
