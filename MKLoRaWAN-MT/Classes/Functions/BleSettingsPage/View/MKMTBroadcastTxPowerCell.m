...
@implementation MKMTBroadcastTxPowerCellModel
@end

@interface MKMTBroadcastTxPowerCell ()
...
@implementation MKMTBroadcastTxPowerCell

+ (MKMTBroadcastTxPowerCell *)initCellWithTableView:(UITableView *)tableView {
    MKMTBroadcastTxPowerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMTBroadcastTxPowerCellIdenty"];
    if (!cell) {
        cell = [[MKMTBroadcastTxPowerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMTBroadcastTxPowerCellIdenty"];
    }
    return cell;
}
...
- (void)txPowerSliderValueChanged {
    ...
    if ([self.delegate respondsToSelector:@selector(mt_txPowerValueChanged:)]) {
        [self.delegate mt_txPowerValueChanged:(NSInteger)self.slider.value];
    }
}
...
#pragma mark - setter
- (void)setDataModel:(MKMTBroadcastTxPowerCellModel *)dataModel {
    _dataModel = nil;
