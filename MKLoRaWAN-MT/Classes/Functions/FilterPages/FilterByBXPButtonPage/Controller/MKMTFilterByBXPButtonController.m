//
//  MKMTFilterByBXPButtonController.m
...
@interface MKMTFilterByBXPButtonController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMTFilterByBXPButtonModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKMTFilterByBXPButtonController

- (void)dealloc {
    NSLog(@"MKMTFilterByBXPButtonController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MT", @"MKMTFilterByBXPButtonController", @"mt_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMTFilterByBXPButtonModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMTFilterByBXPButtonModel alloc] init];
    }
    return _dataModel;
}
