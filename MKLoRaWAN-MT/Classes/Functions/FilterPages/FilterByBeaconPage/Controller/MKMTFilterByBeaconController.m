//
//  MKMTFilterByBeaconController.m
...
@interface MKMTFilterByBeaconController ()<UITableViewDelegate,
UITableViewDataSource,
mk_textSwitchCellDelegate,
MKMTFilterNormalTextFieldCellDelegate,
MKMTFilterBeaconCellDelegate>
...
@property (nonatomic, strong)MKMTFilterByBeaconModel *dataModel;

@end

@implementation MKMTFilterByBeaconController

- (void)dealloc {
    NSLog(@"MKMTFilterByBeaconController销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MKMTFilterBeaconCell *cell = [MKMTFilterBeaconCell initCellWithTableView:tableView];
...
#pragma mark - MKMTFilterBeaconCellDelegate
- (void)mk_mt_beaconMinValueChanged:(NSString *)value index:(NSInteger)index {
    MKMTFilterBeaconCellModel *cellModel = self.section2List[index];
...
- (void)loadSection1Datas {
    MKMTFilterNormalTextFieldCellModel *cellModel = [[MKMTFilterNormalTextFieldCellModel alloc] init];
    cellModel.index = 0;
    if (self.pageType == mk_mt_filterByBeaconPageType_beacon) {
...
- (void)loadSection2Datas {
    MKMTFilterBeaconCellModel *cellModel1 = [[MKMTFilterBeaconCellModel alloc] init];
    cellModel1.index = 0;
    cellModel1.minValue = self.dataModel.minMajor;
    cellModel1.maxValue = self.dataModel.maxMajor;
    [self.section2List addObject:cellModel1];
    
    MKMTFilterBeaconCellModel *cellModel2 = [[MKMTFilterBeaconCellModel alloc] init];
    cellModel2.index = 1;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MT", @"MKMTFilterByBeaconController", @"mt_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMTFilterByBeaconModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMTFilterByBeaconModel alloc] init];
