//
//  MKMTFilterByBXPTagController.m
...
@interface MKMTFilterByBXPTagController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMTFilterByBXPTagModel *dataModel;

@end

@implementation MKMTFilterByBXPTagController

- (void)dealloc {
    NSLog(@"MKMTFilterByBXPTagController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MT", @"MKMTFilterByBXPTagController", @"mt_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMTFilterByBXPTagModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMTFilterByBXPTagModel alloc] init];
    }
    return _dataModel;
}
