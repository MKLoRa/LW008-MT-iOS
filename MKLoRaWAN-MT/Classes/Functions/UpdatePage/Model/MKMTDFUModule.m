...
@interface MKMTDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKMTDFUModule

- (void)dealloc{
    NSLog(@"MKMTDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKMTCentralManager shared].peripheral];
}
