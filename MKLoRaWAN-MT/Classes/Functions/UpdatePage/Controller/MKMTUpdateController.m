...
@interface MKMTUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKMTDFUModule *dfuModule;
...
@implementation MKMTUpdateController

- (void)dealloc {
    NSLog(@"MKMTUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_mt_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKMTCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_mt_centralDeallocNotification" object:nil];
...
- (MKMTDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKMTDFUModule alloc] init];
    }
    return _dfuModule;
}
