...
@interface MKMTDeviceModeController ()<UITableViewDelegate,
...
@implementation MKMTDeviceModeController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 1 && indexPath.row == 0) {
        //MKMTTimingModeController
        MKMTTimingModeController *vc = [[MKMTTimingModeController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 1 && indexPath.row == 1) {
        //Periodic Mode
        MKMTPeriodicModeController *vc = [[MKMTPeriodicModeController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 1 && indexPath.row == 2) {
        //Motion Mode
        MKMTMotionModeController *vc = [[MKMTMotionModeController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
}
