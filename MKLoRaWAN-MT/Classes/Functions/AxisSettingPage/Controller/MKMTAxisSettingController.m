...
@interface MKMTAxisSettingController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMTAxisSettingDataModel *dataModel;

@end

@implementation MKMTAxisSettingController

- (void)dealloc {
    NSLog(@"MKMTAxisSettingController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MT", @"MKMTAxisSettingController", @"mt_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMTAxisSettingDataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMTAxisSettingDataModel alloc] init];
    }
    return _dataModel;
}
